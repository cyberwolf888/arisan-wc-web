...
import { updateAssignmentAction, type TeamOption } from "../../actions";
  ...
  return (
    <section className="w-full">
      <div className="mx-auto w-full max-w-xl rounded-2xl border border-border/60 bg-card p-5 shadow-sm sm:p-6">
        <h1 className="text-xl font-semibold tracking-tight">Reassign Team</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Change the team or the assigned member for this assignment.
        </p>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Change the team for this assignment.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Change the member assigned to this team.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
